...
/** Field carrying the assistant-text preview bound (0 = never truncate). */
export const TRUNCATE_MESSAGE_CHARS_FIELD = 'truncateMessageChars'
...
/** Default preview bound: only pathological assistant text crosses it. */
export const DEFAULT_TRUNCATE_MESSAGE_CHARS = 50_000
...
export interface ConversationSettings {
  ...
  /** Assistant text above this length renders as a truncated preview with an expand toggle (0 disables). */
...
export const ConversationSettingsSchema: z<ConversationSettings> = z.object({
  ...
  [TRUNCATE_MESSAGE_CHARS_FIELD]: z.natural().default(DEFAULT_TRUNCATE_MESSAGE_CHARS),
})
