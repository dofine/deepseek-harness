...
export const zh = {
  ...
  'message.stopped': '已停止',
  'message.truncated.expand': '内容已截断（共 {total} 字符）· 展开全部',
  'message.truncated.collapse': '折叠',
...
export const en = {
  ...
  'message.truncated.expand': 'Truncated ({total} chars) · Show all',
  'message.truncated.collapse': 'Collapse',
